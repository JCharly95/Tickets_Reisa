...
<a href="" class="btn btn-primary btn-lg btn-block"  data-toggle="modal" data-target="#modalLoginForm"><i class="fas fa-plus-circle "> Agregar Usuario</i></a>
<a href="" class="btn btn-danger btn-lg btn-block"  data-toggle="modal" data-target="#modalEditForm"><i class="fas fa-edit "> Editar Usuario</i></a>
...
<div class="modal fade" id="modalEditForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold">Editar un registro</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
    ...
    <div class="modal-footer d-flex justify-content-center">
        <button type="submit"class="btn btn-danger" id="edit_button">Buscar</button>
    </div>
    </div>
    </form>  
  </div>
