...
$insert=mysqli_query($conexion,"INSERT INTO usuarios (NSS, Nombre, Fec_Nac, Correo, Contra, Tip_User, Sta_User) VALUES 
('$nss','$nombre','$fec_nac', '$correo', '$contra', '$tipo_user', '$status')");    
if($insert){
    echo"Usuario registrado exitosamente";
}
else{
    echo"No se ha podido registrar el usuraio";
}
}
?>
